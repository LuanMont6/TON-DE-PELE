...
function updateLoginArea() {
  ...
  if (currentUser) {
    ...
    adminContainer.innerHTML = `<button class="login-btn" onclick="logout()">Sair</button>`;
    // mobile drawer: Sair
...
const SEED_PRODUCTS = [
  ...
  {id:5,cat:'Vestido',name:'Vestido Slip Coral',price:'R$ 249,00',oldPrice:'',badge:'',colors:['#D8634A','#2A1F1F','#5A7A8A'],sizes:['PP','P','M','G'],desc:'Vestido slip em tecido leve com alças finas ajustáveis. Corte midi fluido com acabamento delicado.',media:[],ytLink:'',svgPath:`<svg width="90" height="80" viewBox="0 0 90 80" fill="none"><ellipse cx="45" cy="35" rx="38" ry="28" fill="#C9848A" opacity="0.45"/><path d="M7 35 Q15 60 25 72 L65 72 Q75 60 83 35 Q65 55 45 52 Q25 55 7 35Z" fill="#C9848A" opacity="0.8"/></svg>`},
